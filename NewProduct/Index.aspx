...
<body>
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button Text="Save" ID="btnSave" runat="server" OnClick="btnSave_Click" class="buttonsave"/>
                    <asp:Button Text="Delete" ID="btnDelete" runat="server" OnClick="btnDelete_Click" class="buttondelete"/>
                    <asp:Button Text="Clear" ID="btnClear" runat="server" OnClick="btnClear_Click" class="buttonclear"/>
                </td>
            </tr>
